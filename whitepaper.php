...
<head>
    ...
    <link rel="icon" href="img/svg/tokentoline.svg" type="image/x-icon">
    <meta charset="UTF-8">
    <meta name="description" content="TokenToLine">
    <meta name="keywords" content="TokenToLine, tokentoline, ttl, TTL">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <link rel="stylesheet" href="css/unstyles.css">
